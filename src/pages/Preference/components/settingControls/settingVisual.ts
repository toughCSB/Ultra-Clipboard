...
const SETTING_ICON_MAP: Record<string, string> = {
  ...
  "shortcuts.captureArea": "i-lucide:scan",
  "shortcuts.captureDelayed": "i-lucide:timer",
  "shortcuts.captureFullscreen": "i-lucide:monitor",
  "shortcuts.captureRepeat": "i-lucide:repeat",
  "shortcuts.captureWindow": "i-lucide:app-window",
