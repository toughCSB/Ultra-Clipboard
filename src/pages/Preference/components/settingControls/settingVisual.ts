...
const SETTING_ICON_MAP: Record<string, string> = {
  ...
  "webdav.enabled": "i-lucide:cloud",
  "webdav.fileName": "i-lucide:file-archive",
  "webdav.password": "i-lucide:key-round",
  "webdav.pull": "i-lucide:cloud-download",
  "webdav.push": "i-lucide:cloud-upload",
  "webdav.url": "i-lucide:link",
  "webdav.username": "i-lucide:user",
